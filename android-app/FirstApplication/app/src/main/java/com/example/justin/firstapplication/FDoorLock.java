 ...
 * Created by Justin on 4/12/2016.
 */
public class FDoorLock extends Activity {
    ...
    private static String ScriptURL = "http://ded01.stormat.ca/~justin/android/lock.php";
    ...
    class LoadUsers extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FDoorLock.this);
            pDialog.setMessage("Locking Door. Please wait...");

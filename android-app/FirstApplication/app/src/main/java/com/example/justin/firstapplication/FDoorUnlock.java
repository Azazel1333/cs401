 ...
 */
public class FDoorUnlock extends Activity {
    ...
    private static String ScriptURL = "http://ded01.stormat.ca/~justin/android/unlock.php";
    ...
    class LoadUsers extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FDoorUnlock.this);
